...
<div class="container">
    <div class="jumbotron" id="home">
        ...
        <form>
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="spear" placeholder="Spearmen">
                <label for="sword">Zwaardvechter</label>
                <input type="number" class="form-control" id="sword" placeholder="Swordsmen">
                <label for="axe">Bijlman</label>
                <input type="number" class="form-control" id="axe" placeholder="Axemen">
                <label for="archer">Boogschutter</label>
                <input type="number" class="form-control" id="archer" placeholder="Archers">
            </div>
            <div class="form-group">
                <label for="time">Time</label>
                <input type="number" class="form-control" id="time" aria-describedby="timeHelp" placeholder="Time">
                <small id="timeHelp" class="form-text text-muted">Enter the time you would like your troops to be gone, in hours</small>
            </div>
        ...
        <div id="results" class="table-responsive">
            <table class="table" style="margin-top: 2rem;">
                ...
                <tr>
                    ...
                    <th scope="col">Swordsmen</th>
                    <th scope="col">Axemen</th>
    ...
    <div class="jumbotron" id="about" style="display:none;">
        <h1 class="display-4">Tribal Wars Scavange Calculator!</h1>
        <p class="lead">This calculator was developed by &copy; Jorn Schampheleer</p>
        <hr class="my-4">
        <p>Based on the script of Warre in the fora.</p>
    </div>
</div>
